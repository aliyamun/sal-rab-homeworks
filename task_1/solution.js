function addInCartMessage(title, price) {
    ...
    // добавьте в конец переменной message пробел
    message = ' ' + 'за' + ' ' + productPrice + ' ' + 'теперь в корзине!'; // добавьте в конец переменной message текст 'теперь в корзине!'
...
function addInCartSumChange(sum, delta) {
    ...
    let newSumText = newSum + 'Р'; // создайте переменную newSumText и присвойте ей результат склеивания переменной newSum и текста ' ₽'
    newSumText = `${newSum} Р`; // замените склеивание, используемое в newSum Text на шаблонную строку
